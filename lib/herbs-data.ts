...
export const herbs: Herb[] = [
  {
    ...
    benefits: [
      ...
      { en: 'Antimicrobial properties', es: 'Golpe de garganta marcado' },
      { en: 'Digestive aid', es: 'Apoyo digestivo' },
    ],
    effects: {
      en: 'A warming, cleansing sensation with subtle earthiness. Promotes clear breathing and mental clarity.',
      es: 'Humo terroso y fuerte, con un toque especiado que raspa la garganta de forma característica. Aporta el carácter que extraña el fumador de tabaco.',
    },
    description: {
      en: 'Thyme has been used for centuries in traditional medicine for its powerful respiratory benefits. Its natural compounds help open airways and provide a grounding, herbal experience.',
      es: 'El Tomillo es la hierba del carácter. Su humo denso y picante emula el golpe de garganta del cigarro convencional, mientras actúa como desinfectante de las vías aéreas. Es el ingrediente que hace que una mezcla se sienta seria.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Mood enhancement', es: 'Ánimo estable' },
      { en: 'Mental relaxation', es: 'Relajación lúcida' },
    ],
    effects: {
      en: 'A gentle, uplifting calm that eases tension without sedation. Promotes positive mood and mental ease.',
      es: 'Una calma ligera que afloja el pecho apretado sin dar sueño. Deja una sensación de ligereza mental que permite seguir funcionando.',
    },
    description: {
      en: 'Lemon Balm brings a bright, citrusy note to any blend while providing natural calming properties. It helps quiet racing thoughts and promotes a sense of peaceful alertness.',
      es: 'La Melisa aporta un corazón herbal-cítrico que calma sin apagar. A diferencia de la Pasiflora, es una hierba de día: reduce la tensión y el estrés crónico mientras se trabaja, sin somnolencia.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Sleep support', es: 'Apoyo al descanso' },
      { en: 'Anxiety reduction', es: 'Menos irritabilidad' },
    ],
    effects: {
      en: 'A warm, gentle wave of relaxation that settles the mind and body. Perfect for unwinding after a long day.',
      es: 'Una ola cálida y suave que asienta la mente y el cuerpo. Ideal para bajar revoluciones al final de una jornada larga.',
    },
    description: {
      en: "Chamomile is the quintessential relaxation herb. Its gentle, apple-like sweetness creates a soothing experience that helps release the day's tensions.",
      es: 'La Manzanilla es confort psicológico en forma de humo. Su aroma dulce y familiar evoca hogar y seguridad, y su acción antiinflamatoria relaja la tensión muscular acumulada. Suaviza los primeros días sin nicotina.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Focus enhancement', es: 'Calma el sistema nervioso' },
      { en: 'Energy boost', es: 'Sabor distintivo' },
    ],
    effects: {
      en: 'A subtle, invigorating lift that sharpens focus and provides gentle energy without jitters.',
      es: 'Entrada dulce con notas de anís y un humo cálido y reconfortante. Equilibra los espasmos causados por el estrés.',
    },
    description: {
      en: "Pericorn offers a unique stimulating experience, providing natural energy and mental clarity. Ideal for those seeking an alternative to tobacco's stimulating effects.",
      es: 'El Pericón es el secreto ancestral de nuestras mezclas: la nota de sabor que la competencia no tiene. Dulce, anisado y profundamente guatemalteco, relaja el sistema digestivo y nervioso a la vez.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Aphrodisiac properties', es: 'Relajación lúcida' },
      { en: 'Nervous system support', es: 'Sin bajón posterior' },
    ],
    effects: {
      en: 'A warm, euphoric feeling that lifts the spirits and creates a sense of well-being and connection.',
      es: 'Euforia leve y relajación lúcida, con un humo de sutiles notas dulces. Estimula sin generar ansiedad ni acelerar el pulso.',
    },
    description: {
      en: 'Damiana has been treasured for centuries for its mood-enhancing and aphrodisiac qualities. It creates a gentle euphoria and sense of openness.',
      es: 'La Damiana es el conector social. Reemplaza el cigarro de fiesta o reunión aportando una vibra alegre y relajada, sin los bajones de la nicotina. Estimula el sistema nervioso mejorando el estado de ánimo.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Emotional balance', es: 'Reduce el enojo' },
      { en: 'Anti-inflammatory', es: 'Retrogusto elegante' },
    ],
    effects: {
      en: 'A gentle, heart-centered experience that promotes emotional openness and self-compassion.',
      es: 'Humo ligero con un retrogusto floral perfumado. Calma crisis emocionales y suaviza la irritabilidad de la abstinencia.',
    },
    description: {
      en: 'Rose petals bring elegance and emotional depth to any blend. Known for opening the heart chakra and promoting feelings of love and acceptance.',
      es: 'Las Rosas son el ingrediente estético por excelencia. Elevan el espíritu y el estatus del ritual, aportando elegancia visual al empaque y un perfume delicado al humo. Nuestra cosecha es familiar.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Lymphatic support', es: 'Protege boca y garganta' },
      { en: 'Gentle healing', es: 'Calada balanceada' },
    ],
    effects: {
      en: 'A warm, sunny energy that brings comfort and promotes internal balance and healing.',
      es: 'Humo suave y sin aristas. Su función principal es técnica: regula la velocidad de combustión para que el cigarrillo queme parejo.',
    },
    description: {
      en: 'Also known as marigold, Calendula brings solar energy and gentle healing properties. It adds a warm, comforting quality to blends.',
      es: 'La Caléndula es el ecualizador. Es el ingrediente detrás de bambalinas que garantiza que el cigarrillo no se apague a la mitad y que cada calada sea suave. Además, es cicatrizante y protege los tejidos del calor.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Circulation boost', es: 'Estimula la memoria' },
      { en: 'Mental clarity', es: 'Despeja la fatiga mental' },
    ],
    effects: {
      en: 'An awakening, clarifying sensation that sharpens the mind and improves focus and recall.',
      es: 'Humo denso, aromático y vigorizante para los sentidos. Actúa como un despertador cerebral sin alterar el pulso cardíaco.',
    },
    description: {
      en: 'The herb of remembrance, Rosemary has been used since ancient times to enhance memory and mental performance. Its invigorating aroma stimulates the senses.',
      es: 'El Romero rompe el mito de que las plantas solo sirven para dormir. Mejora la circulación cerebral y la concentración, lo que lo hace ideal para escritores, programadores y profesionales en jornadas de enfoque intenso.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Decongestant', es: 'Descongestiona' },
      { en: 'Antimicrobial', es: 'Antiséptico respiratorio' },
    ],
    effects: {
      en: 'A cooling, opening sensation that clears the sinuses and promotes deep, easy breathing.',
      es: 'Expansión pulmonar intensa. Sientes literalmente cómo entra el aire a los pulmones, con una frescura que abre nariz y bronquios.',
    },
    description: {
      en: 'Eucalyptus provides powerful respiratory support with its cooling menthol-like properties. Excellent for clearing airways and promoting fresh breath.',
      es: 'El Eucalipto es la antítesis del humo pesado del tabaco. Es una experiencia de choque: fumar para sentir los pulmones limpios y abiertos. Antiséptico respiratorio profundo para vías altas y bajas.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Stress reduction', es: 'Eleva el ánimo' },
      { en: 'Sensory pleasure', es: 'Cero olor a tabaco' },
    ],
    effects: {
      en: 'An intoxicating, luxurious experience that elevates mood and creates a sense of exotic indulgence.',
      es: 'Aroma penetrante y dulce que perfuma el ambiente en lugar de contaminarlo. Eleva el ánimo de forma inmediata.',
    },
    description: {
      en: 'Jasmine flowers create an exquisitely aromatic experience. Known as the "queen of the night," it promotes feelings of optimism and romantic openness.',
      es: 'El Jazmín es nuestro mejor argumento contra el estigma del fumador. Su humo no apesta la ropa ni las manos: huele a jardín. Alivia la tensión emocional intensa y es ideal para fumadores discretos.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Digestive support', es: 'Descongestiona' },
      { en: 'Mental refreshment', es: 'Refrescante digestivo' },
    ],
    effects: {
      en: 'A crisp, invigorating coolness that awakens the senses and clears the mind. Provides immediate freshness and clarity.',
      es: 'Golpe de garganta fresco, crujiente y estimulante. Abre los bronquios con una frescura que no viene de un químico.',
    },
    description: {
      en: "Mint is nature's breath of fresh air. Its cooling menthol properties open airways, soothe digestion, and create an instantly refreshing smoking experience.",
      es: 'La Menta es la alternativa mentolada real. Captura al fumador huérfano de los cigarrillos con cápsula, ofreciendo frescura de planta y no de laboratorio. Descongestionante y analgésico local suave para la garganta irritada.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Anxiety relief', es: 'Combate el insomnio' },
      { en: 'Sleep support', es: 'Calma palpitaciones' },
    ],
    effects: {
      en: 'A profound, sedative calm that quiets racing thoughts and prepares the body for deep rest. Powerfully tranquilizing.',
      es: 'Sedación ligera, física y mental. Apaga la rumiación de pensamientos y prepara el terreno biológico para dormir.',
    },
    description: {
      en: "Passionflower is one of nature's most potent calming herbs. Used traditionally for insomnia and anxiety, it provides deep relaxation without next-day grogginess.",
      es: 'La Pasiflora es la desconexión nocturna. Es nuestra herramienta para el cigarrillo de antes de dormir: ayuda a romper el hábito de fumar de noche induciendo un descanso natural, y calma las palpitaciones que deja la ansiedad del día.',
    },
    flavorProfile: {
  ...
  },
  {
    ...
    benefits: [
      ...
      { en: 'Purification', es: 'Aclara la mente' },
      { en: 'Hormonal balance', es: 'Humo con cuerpo' },
    ],
    effects: {
      en: 'A grounding, clarifying sensation that cleanses the mind and promotes wisdom. Creates a sense of sacred ritual.',
      es: 'Humo robusto, denso y con carácter. Aclara la mente de inmediato y deja sensación de limpieza en la garganta.',
    },
    description: {
      en: 'Sage has been used for millennia in spiritual and healing practices. Its purifying smoke clears negative energy while promoting mental sharpness and inner balance.',
      es: 'La Salvia es el humo sagrado. Perfecta para quien busca un humo espeso que emule la fuerza del cigarro común, pero purificando el espacio. Sus propiedades antisépticas y astringentes limpian los tejidos respiratorios.',
    },
    flavorProfile: {
...
export const blends: Blend[] = [
  {
    ...
    description: {
      en: 'A gentle, soothing blend designed to ease tension and bring softness to your day. Perfect for those seeking mild relaxation with refreshing clarity.',
      es: 'Mezcla ligera y balanceada que derrite la tensión y el estrés cotidiano. Su humo terso y de notas neutras devuelve el control mental sin restar energía. El sustituto perfecto y sutil para fumar con tranquilidad a lo largo del día.',
    },
    herbs: ['pericorn', 'lemon-balm', 'chamomile', 'mint'],
    primaryEffect: 'calming',
    benefits: [
      { en: 'Gentle relaxation', es: 'Relajación ligera' },
      { en: 'Mental clarity', es: 'Claridad mental' },
      { en: 'Digestive comfort', es: 'Alivio digestivo' },
      { en: 'Stress relief', es: 'Calada sedosa' },
    ],
    bestFor: [
      { en: 'Beginners', es: 'Primera vez' },
      { en: 'Daytime relaxation', es: 'Uso diurno' },
      { en: 'After meals', es: 'Después de comer' },
      { en: 'Light stress relief', es: 'Estrés cotidiano' },
    ],
  ...
  },
  {
    ...
    description: {
      en: 'Nourish your soul with this deeply nurturing blend. A heart-opening combination that promotes emotional balance, self-love, and inner peace.',
      es: 'Una experiencia sensorial y aromática que reconforta el espíritu. La sutil euforia de la damiana se funde con pétalos florales en un humo elegante que eleva el ánimo, disipa la apatía y transforma el hábito en un ritual de auto-cuidado.',
    },
    herbs: ['damiana', 'calendula', 'roses', 'lavender', 'passionflower'],
    primaryEffect: 'calming',
    benefits: [
      { en: 'Emotional balance', es: 'Equilibrio emocional' },
      { en: 'Heart opening', es: 'Humo perfumado' },
      { en: 'Deep relaxation', es: 'Relajación profunda' },
      { en: 'Self-compassion', es: 'Ritual de autocuidado' },
    ],
    bestFor: [
      { en: 'Emotional healing', es: 'Desahogo emocional' },
      { en: 'Self-care rituals', es: 'Rituales personales' },
      { en: 'Anxiety relief', es: 'Irritabilidad por abstinencia' },
      { en: 'Evening wind-down', es: 'Momentos especiales' },
    ],
  ...
  },
  {
    ...
    description: {
      en: 'A protective, purifying blend that supports respiratory health while cleansing mind and spirit. Ideal for those transitioning from tobacco or seeking lung support.',
      es: 'Fórmula botánica que combina la fuerza del romero y la salvia para reconfortar el pecho. Aporta frescura y blindaje, manteniendo tus vías aéreas despejadas frente a la pesadez y la contaminación de la ciudad.',
    },
    herbs: ['mullein', 'sage', 'rosemary', 'jasmine', 'eucalyptus'],
    primaryEffect: 'respiratory',
    benefits: [
      { en: 'Respiratory support', es: 'Defensa respiratoria' },
      { en: 'Mental purification', es: 'Acción antiséptica' },
      { en: 'Airway clearing', es: 'Vías aéreas despejadas' },
      { en: 'Spiritual cleansing', es: 'Humo con cuerpo' },
    ],
    bestFor: [
      { en: 'Tobacco transition', es: 'Uso en exteriores' },
      { en: 'Respiratory concerns', es: 'Contaminación urbana' },
      { en: 'Meditation', es: 'Cambios de estación' },
      { en: 'Morning rituals', es: 'Fumadores de humo fuerte' },
    ],
    timeOfDay: ['morning', 'afternoon'],
    intensity: 'moderate',
  ...
  },
  {
    ...
    description: {
      en: 'Drift into deep, restorative sleep with this powerful nighttime blend. A tranquil combination that quiets the mind and prepares the body for rest.',
      es: 'Una caricia herbal profundamente sedante que relaja la tensión muscular y aquieta la mente. Prepara tu cuerpo para una transición natural hacia un descanso continuo, reparador y verdaderamente profundo.',
    },
    herbs: ['pericorn', 'passionflower', 'lemon-balm', 'lavender'],
    primaryEffect: 'sleep',
    benefits: [
      { en: 'Deep sleep', es: 'Descanso profundo' },
      { en: 'Anxiety relief', es: 'Apaga el ruido mental' },
      { en: 'Racing thought relief', es: 'Relajación muscular' },
      { en: 'Nighttime calm', es: 'Calma nocturna' },
    ],
    bestFor: [
      { en: 'Insomnia', es: 'Insomnio' },
      { en: 'Bedtime routine', es: 'Ritual antes de dormir' },
      { en: 'High anxiety', es: 'Noches inquietas' },
      { en: 'Restless nights', es: 'Rumiación de pensamientos' },
    ],
    timeOfDay: ['night'],
    intensity: 'strong',
  ...
  },
  {
    ...
    description: {
      en: 'The ultimate respiratory support blend. Clears airways, supports lung health, and provides a smooth, clean smoking experience for those prioritizing breath.',
      es: 'Mezcla de grado terapéutico diseñada para quienes deciden dejar atrás el tabaco industrial. Su poderosa combinación activa y expectorante acompaña la limpieza profunda de los pulmones, liberando la pesadez y abriendo tus bronquios.',
    },
    herbs: ['mullein', 'eucalyptus', 'thyme', 'sage', 'mint'],
    primaryEffect: 'respiratory',
    benefits: [
      { en: 'Lung cleansing', es: 'Expectoración natural' },
      { en: 'Airway opening', es: 'Apertura de vías aéreas' },
      { en: 'Respiratory recovery', es: 'Descongestión profunda' },
      { en: 'Smooth smoke', es: 'Golpe de garganta intenso' },
    ],
    bestFor: [
      { en: 'Heavy smoker transition', es: 'Transición del tabaco' },
      { en: 'Respiratory support', es: 'Fumadores pesados' },
      { en: 'Congestion relief', es: 'Congestión y flema' },
      { en: 'Lung health', es: 'Día 1 sin tabaco' },
    ],
